...
mu=m.addVar(lb=1,ub=55,vtype=gb.GRB.CONTINUOUS, name="mu")
delta=m.addVar(ub=51,vtype=gb.GRB.CONTINUOUS, name="delta")
m.addConstr(delta <=mu*0.3)
...
f1=C_invest + 0.8*C_operation[0]+0.1*C_operation[1]+0.1*C_operation[2]
f2=-delta
